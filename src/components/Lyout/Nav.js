        ...
        <React.Fragment>
            ...
            {auth ?
                <ul className="Nav">
                    ...
                    <li className="Navli"><Link to="/update/:id">Update Product</Link></li>
                    <li className="Navli"><Link to="/delete">Delete Product</Link></li>
                    <li className="Navli"><Link to="/profile">Profile</Link></li>
                    <li className="logright"><Link onClick={logout} to="/singup">Logout {JSON.parse(auth).name}</Link></li>
